...
import com.example.user.myakademik.adapter.Adapter;
...
public class dosen extends AppCompatActivity implements
    ...
    private static String url_select = Server.URLdosen + "select.php";
    private static String url_insert = Server.URLdosen + "insert.php";
    private static String url_edit = Server.URLdosen + "edit.php";
    private static String url_update = Server.URLdosen + "update.php";
    private static String url_delete = Server.URLdosen + "delete.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new AdapterDosen(dosen.this, itemList);
    ...
    private void DialogForm(String nimx, String namax, String alamatx, String button) {
        dialog = new AlertDialog.Builder(dosen.this);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                item.setNim(obj.getString(TAG_NIK));
    ...
    private void simpan_update() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                callVolley();
                                kosong();
                                Toast.makeText(dosen.this, jObj.getString(TAG_MESSAGE),
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(dosen.this, error.getMessage(),
                        Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                String nimx = jObj.getString(TAG_NIK);
